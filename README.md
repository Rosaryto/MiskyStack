...
El nombre Misky Stack une dos ideas:

- `Misky`, palabra asociada a lo dulce.
- `Stack`, concepto usado en programación para hablar de un conjunto de tecnologías.
...
- `pages/nueces-confitadas.html`: receta de nueces confitadas.
- `pages/empanadillas-cayote.html`: receta de empanadillas de cayote.
...
- Bootstrap 5 para grilla, componentes y responsive.
- Bootstrap Icons para los iconos de redes sociales.
...
|   |   |-- colaciones-dulce-leche.jpg
|   |   |-- gaznates-dulce-leche.jpg
|   |   |-- alfajor-miel-cana.jpg
|   |   |-- nueces-confitadas.jpg
|   |   |-- empanadillas-cayote.jpg
|   |   `-- pastel-novia.png
|   `-- video/
|       `-- banner-misky-stack.mp4
`-- pages/
    |-- recetas.html
    |-- detalle-receta.html
    ...
    |-- nueces-confitadas.html
    |-- empanadillas-cayote.html
    |-- pastel-novia.html
    `-- error404.html
```
...
2. Entrar a Netlify.
3. Crear un nuevo sitio desde el repositorio.
4. Dejar el comando de build vacío porque es una web estática.
